...
/**
 * Product catalog *template*. Default prices here are prefill conveniences only;
 * the authoritative price/cost for margin is snapshotted onto each weekly listing
 * so historical P&L stays correct when these defaults change later.
 */
export const products = sqliteTable(
  ...
  (t) => [
    unique("products_supplier_slug_uq").on(t.supplierId, t.slug),
